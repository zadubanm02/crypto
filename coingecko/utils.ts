...
export const getTopTen = () => {
    return axios.get(`https://api.coingecko.com/api/v3/coins/markets?vs_currency=eur&order=market_cap_desc&per_page=15&price_change_percentage=24h&sparkline=true`)
        .then((res) => res.data)
